...
def main():
    ...
    parser.add_argument('--amqp-host', action='store',help='Host or IP of MQTT server', default='localhost')
    parser.add_argument('--amqp-port', action='store',help='Port of MQTT server', default='1883')
    parser.add_argument('--amqp-queue', action='store',help='Queue used to send message', default='localhost')
